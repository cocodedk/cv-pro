...
- **Location**: Supabase CLI (local) or hosted

**Responsibilities**:
- CV data storage with row-level security
- User isolation and auth enforcement
...
4. Backend saves data to Supabase/PostgreSQL
